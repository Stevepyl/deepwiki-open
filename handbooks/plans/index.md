...
| [PLAN-004 - Welcome and Projects Directory](PLAN-004-welcome-and-projects.md) | `proposed` | `not-started` | Plan frontmatter is `status: proposed`; `src_old/app/page.tsx` is 627 lines rendering the current home; `src_old/app/wiki/projects/page.tsx` is the active projects route and `src_old/app/projects/` does not exist. Now carries a Tailwind-first styling rule shared with PLAN-005 and PLAN-006. | Depends on PLAN-003. |
...
| PLAN-004 | Rewrite `src_old/app/page.tsx` welcome route | `not-started` | Under 120 lines target. |
| PLAN-004 | Create `src_old/app/projects/page.tsx` and delete `src_old/app/wiki/projects/` | `not-started` | New `/projects` URL per PLAN-002 D8. |
